...
class _NotificationsScreenState extends State<NotificationsScreen> {
  final List<Map<String, dynamic>> _notifications = [
    ...
    {
      'id': '5',
      'title': 'Heritage App Support',
      'titleGu': 'હેરિટેજ એપ સપોર્ટ',
      'message': 'Welcome to Heritage App! Connect with your community legacy and members.',
      'messageGu': 'હેરિટેજ એપમાં આપનું સ્વાગત છે! તમારા સમુદાયના વારસા સાથે જોડાઓ.',
      'time': '3 days ago',
